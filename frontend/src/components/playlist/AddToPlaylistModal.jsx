            ...
            <div className={`playlist-modal-content ${view === 'create' ? 'expanded' : ''}`} onClick={(e) => e.stopPropagation()}>
                ...
                {songToAdd && view === 'list' && (
                    <div className="song-preview-text">
                        ...
                        <div className="song-preview-status">
                    ...
                    <div className="playlist-list-container">
                        <div className="playlists-scroll-area">
                            {loading && playlists.length === 0 ? (
                                <p className="loading-msg">Ładowanie...</p>
                            ) : (
                                playlists.length > 0 ? (
                                    playlists.map(pl => {
                                        ...
                                        return (
                                            <div
                                                key={pl.id}
                                                className={`playlist-row ${isBlocked ? 'blocked' : ''}`}
                                            ...
                                            >
                                                ...
                                                <div className="playlist-info-row">
                                                    ...
                                                    <div className="playlist-meta-col">
                                    ...
                                    <p className="no-playlists-msg">Brak playlist</p>
                                )
                            )}
                        </div>
                ...
                {view === 'create' && (
                    <div className="create-playlist-form">
                        ...
                        <div className="form-group">
                            ...
                            <input id="playlist-cover-upload" type="file" accept="image/png, image/jpeg, image/webp" onChange={handleFileChange} className="hidden-input" />
                            {imgSrc && (
                                <div className="playlist-cropper-container">
                                    <ReactCrop
                                        ...
                                        aspect={1}
                                    >
                                        <img ref={imgRef} src={imgSrc} alt="Cover" onLoad={onImageLoad} />
                                    </ReactCrop>
                                </div>
                            )}
                        </div>
